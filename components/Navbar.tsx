...
export default function Navbar() {
  ...
  return (
    <nav className="bg-sky-400 p-4 hover:bg-white font-bold">
      <div className="flex items-center justify-between">
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-0 right-0 bg-blue-600 text-white p-4 rounded-md shadow-lg w-3/4 mt-12">
            <a href="#home" className="block py-2 px-4 hover:bg-blue-700">
              Home
            </a>
            <a href="#collections" className="block py-2 px-4 hover:bg-blue-700">
              Collections
            </a>
